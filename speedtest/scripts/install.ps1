# nodecoop-speedtester Windows install & run script
...
$BinaryName = "nodecoop-speedtester"
...
$Release = Invoke-RestMethod -Uri $ReleaseUrl -Headers @{ "User-Agent" = "nodecoop-installer" }
